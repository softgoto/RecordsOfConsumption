...
{
    NavBarButtonItem *item = [[NavBarButtonItem alloc]initWithType:type];
    item.title = title;
...
//        {
//            image = [UIImage imageNamed:RightItemImage];
//            image_s = [UIImage imageNamed:RightItemSelectedImage];
//        }
//            break;
//        case NavBarButtonItemTypeLeft:
//        {
//            image = [UIImage imageNamed:LeftItemImage];
//            image_s = [UIImage imageNamed:LeftItemSelectedImage];
//        }
//            break;
        default:
            break;
...
- (void)titleOffsetWithType
{
    switch (_itemType) {
        case NavBarButtonItemTypeBack:
        {
            [_button setContentEdgeInsets:LeftItemOffset];
        }
            break;
//        case NavBarButtonItemTypeDefault:
//        {
//            [_button setContentEdgeInsets:RightItemOffset];
//        }
//            break;
//        case NavBarButtonItemTypeLeft:
//        {
    ...
    if (!highlightedWhileSwitch) {
    ...
    }else
        {
            switch (_itemType) {
                ...
                case NavBarButtonItemTypeDefault:
                {
                    image = [UIImage imageNamed:RightItemSelectedImage];
                    
                }
                    break;
                case NavBarButtonItemTypeLeft:
                {
                    image = [UIImage imageNamed:LeftItemSelectedImage];
                }
                    break;
                default:
                    break;
...
{
    NavBarButtonItem *buttonItem = [NavBarButtonItem defauleItemWithTarget:target action:action title:title type:NavBarButtonItemTypeLeft];
...
{
    NavBarButtonItem *buttonItem = [NavBarButtonItem defauleItemWithTarget:target action:action title:title type:NavBarButtonItemTypeDefault];
...
{
    NavBarButtonItem *buttonItem = [NavBarButtonItem backItemWithTarget:target action:action title:@""];
    self.leftBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:buttonItem.button];
}

- (void)setBackItemWithTarget:(id)target action:(SEL)action title:(NSString *)title
{
    NavBarButtonItem *buttonItem = [NavBarButtonItem backItemWithTarget:target action:action title:title];
    self.leftBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:buttonItem.button];
}
